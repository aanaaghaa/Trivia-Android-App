...
class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.Holder> {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        holder.txtTaskAddDate.setText(String.valueOf(taskModelList.get(position).getTaskAddedDate()));
    }
    ...
    public class Holder extends RecyclerView.ViewHolder {
        TextView txtTaskName, txtTaskAddTime,txtTaskAddDate;
        public Holder(@NonNull View itemView) {
            super(itemView);
            txtTaskName = itemView.findViewById(R.id.txt_task_name);
            txtTaskAddTime = itemView.findViewById(R.id.txt_time);
            txtTaskAddDate = itemView.findViewById(R.id.txt_date);
        }
    }
}
